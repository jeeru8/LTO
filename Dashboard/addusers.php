<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $birthday = $_POST['birthday'];
                    ...
                    $sql = "INSERT INTO users(email_address,phone_number,password,fullname,age,birthday) 
                            VALUES('$email_address', '$phone_number', '$password', '$fullname', '$age', '$birthday')";
                         ...
                         if($query){
                              $note= "SUCCESSFULLY REGISTERED USER";
                            
                             }

                             else{
                              $alert= "ERROR IN REGISTERED";
                             }
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="users.php"><em class="fa fa-bar-chart">&nbsp;</em> Users</a></li>
			<li><a href="ticket.php"><em class="fa fa-bar-chart">&nbsp;</em> Issue Ticket</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
					...
					<h1 class="alert alert-success" align="center">Add Enforcers</h1>
