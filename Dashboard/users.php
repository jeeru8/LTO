...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
				...
				<div class="col-xs-12 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-blue"></em>
							<div class="large"><div>
							<div class="text-muted">Total User Registrations</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Enforcers Registrations </h3>
                                         	...
                                         	<?php
												...
												if ($result->num_rows > 0) {
												    ...
												    while($row = $result->fetch_assoc()) {
												        ...
												        echo '<td>';
												        echo  '<a href="deleteusers.php?id='.$row['id'].'" class="btn btn-danger">Delete User</a>';
			...
			<a href="addusers.php" class="btn btn-success btn-lg">ADD USERS</a>
